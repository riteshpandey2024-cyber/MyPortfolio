...
const About = ({ isDarkMode }) => {
  return (
    <motion.div
      id="about"
      className="w-11/12 max-w-7xl mx-auto py-20 scroll-mt-20"
      initial={{ opacity: 0 }}
      ...
      >
        ...
        >
          <p className="mb-10 max-w-2xl font-Outfit text-gray-600 dark:text-gray-400 text-base leading-relaxed">
            I'm a passionate Software Engineering and AI-ML enthusiast with
            practical experience gained through academic and personal projects.
            I enjoy transforming ideas into scalable applications while
            continuously improving my technical knowledge and problem-solving
            skills.
            <br />
            <b>Core Strengths:</b>
            <br />
            Core Strengths Full-Stack Development (React.js, Node.js,
            Express.js)
            <br />
            Artificial Intelligence, Machine Learning, Deep Learning, NLP, Langchain, Generative AI
            <br />
            Python & JavaScript Development
            <br />
            Cloud Computing (AWS) & Git/GitHub
            <br />
            Data Structures & Algorithms (600+ Problems Solved)
            <br />
            Team Collaboration, Leadership and Technical Communication 
          </p>
          ...
          <ul className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl">
            {infoList.map(
              (
                { icon, iconDark, title, description, link, accentColor },
                index,
              ) => (
                <motion.li
                  initial={{ opacity: 0, y: 20 }}
                ...
                >
                  ...
                  <div
                    className={`absolute top-0 left-0 w-full h-[3px] bg-gradient-to-r ${accentColor}`}
                  ></div>
                  ...
                  {link ? (
                    <a
                      ...
                      className="block h-full w-full p-6"
                    >
                      <Image
                        ...
                        className="w-7"
                      />
                      <h3 className="mt-4 mb-2 font-semibold font-Outfit text-gray-800 dark:text-white text-base">
                        {title}
                      </h3>
                      <p className="text-sm font-Outfit font-medium text-gray-500 dark:text-gray-400 leading-relaxed">
                        {description}
                      </p>
                    </a>
                  ) : (
